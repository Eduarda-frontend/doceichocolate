											...
											<div className="grid grid-cols-3 gap-3">
												{section.options.map(
													(option) => (
														<div
															key={option.id}
															className="flex items-center space-x-3 p-3 rounded-lg hover:bg-[hsl(var(--yellow-sweet))]  transition-colors bg-white/50 backdrop-blur-sm border border-primary/20"
														>
															<input
																type="radio"
																value={
